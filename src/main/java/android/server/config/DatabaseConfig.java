...
@Configuration
@EnableJpaRepositories("android.server.repository")
@EnableTransactionManagement
@PropertySource("classpath:db.properties")
@ComponentScan("android.server")
public class DatabaseConfig {
    ...
    private Properties getHibernateProperties() {
        try {
            ...
            throw new IllegalArgumentException("No found hibernate.properties");
        }
    }
